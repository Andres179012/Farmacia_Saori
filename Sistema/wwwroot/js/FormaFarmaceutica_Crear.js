...
$(document).ready(function () {
    ...
    $("#form").validate({
        ...
        messages: {
            Forma_Farmaceutica: "(Este campo obligatorio)"
        },
        errorElement: 'span'
    });
    ...
    tabladata = $('#tbdata').DataTable({
        "ajax": {
            "url": "/FormaFarmaceutica/Obtener",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            { "data": "id_FormaFarmaceutica", "width": "10%" },
            { "data": "forma_Farmaceutica", "width": "20%" },
...
function eliminar($id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            jQuery.ajax({
                url: "/FormaFarmaceutica/Eliminar" + "?id=" + $id,
                type: "GET",
                dataType: "json",
