...
$(document).ready(function () {
    ...
    $("#form").validate({
        rules: {
            Forma_Faumaceutica: "required"
        },
        messages: {
            Forma_Faumaceutica: "(Este campo obligatorio)"
    ...
    tabladata = $('#tbdata').DataTable({
        ...
        "columns": [
            { "data": "id_FormaFarmaceutica", "width": "10%" },
            { "data": "forma_Faumaceutica", "width": "20%" },
...
function abrirPopUpForm(json) {
   ...
   $("#txtid").val(0);
        ...
        if (json != null) {
            ...
            $("#txtFormaFarmaceutica").val(json.forma_Faumaceutica);
    ...
    if ($("#form").valid()) {
        ...
        var request = {
            objeto: {
                ...
                forma_Faumaceutica: $("#txtFormaFarmaceutica").val(),
        ...
        jQuery.ajax({
            url: "/FormasFarmaceuticas/Guardar",
            type: "POST",
            data: request,
...
function eliminar($id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            jQuery.ajax({
                url: "/FormasFarmaceuticas/Eliminar" + "?id=" + $id,
                type: "GET",
                dataType: "json",
