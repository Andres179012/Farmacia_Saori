...
$('#btnBuscar').on('click', function () {
    ...
    jQuery.ajax({
        url: $.MisUrls.url._ObtenerReporteDevolucionVenta + "?fechainicio=" + $("#txtFechaInicio").val() + "&fechafin=" + $("#txtFechaFin").val(),
        type: "GET",
        dataType: "json",
            ...
            if (data != undefined && data != null) {
                ...
                $.each(data, function (i, row) {
                    ...
                    $("<tr>").append(
                        ...
                        $("<td style='color:black'>").text(row["NombreCliente"]),
...
function printData() {
    ...
    newWin.document.write("<h2 style='color:white;'>Reporte de Devolucion/Cliente Farmacia Saori</h2>");
