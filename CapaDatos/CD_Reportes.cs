...
namespace CapaDatos
{
    public class CD_Reportes
    {
        ...
        public List<ReporteCompra> ReporteCompra(DateTime FechaInicio, DateTime FechaFin, int IdUsuario)
        {
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            lista.Add(new ReporteCompra()
                            {
                                ...
                                TotalCosto = Convert.ToDecimal(dr["TotalCosto"].ToString(), new CultureInfo("es-PE")).ToString("N", formato),
